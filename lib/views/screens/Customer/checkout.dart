            ...
            try {
              await productRef.runTransaction((Object? currentData) {
                ...
                /*else if (productType == 'Product Variants') {
                  ...
                  final orderSize = entry.value['size']?.toString();
                  final orderColor = entry.value['color']?.toString();
                  ...
                  for (int i = 0; i < variations.length; i++) {
                    ...
                    bool colorExists = varColor != null;
                    bool sizeExists = varSize != null;
                    ...
                    if (match) {
                      int varQty = (variation['quantity'] is String)
                          ? int.tryParse(variation['quantity']) ?? 0
                          : (variation['quantity'] as int? ?? 0);

                      varQty = max(varQty - orderedQty, 0);
