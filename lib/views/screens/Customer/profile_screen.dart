...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadCustomerData() async {
    ...
    if (userSnapshot.exists) {
      ...
      if (userData != null && userData["role"]?.toString().toLowerCase() == "customer") {
        setState(() {
          _customerName = userData["fullName"]?.toString();
          ...
          _buildSettingItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (context, animation, secondaryAnimation) => MyOrders(),
                  transitionsBuilder: (context, animation, secondaryAnimation, child) {
