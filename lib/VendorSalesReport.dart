...
class OrderReportScreen extends StatefulWidget {
  ...
  const OrderReportScreen({Key? key, required this.vendorId}) : super(key: key);
    ...
    try {
      ...
      if (vendorSnapshot.snapshot.value != null) {
        ...
        setState(() {
          ...
          vendorName = vendorData['name']?.toString() ?? "Vendor";
        });
      }
    } catch (e) {
      ...
      ordersMap.forEach((orderId, orderData) {
        if (orderData['items'] != null) {
          ...
          items.forEach((itemId, itemData) {
            if (itemData['vendorId'] == widget.vendorId) {
          ...
          if (vendorItems.isNotEmpty) {
            ...
            loadedOrders.add({
              ...
              'earning': vendorOrderTotal * 0.95,
              'commission': vendorOrderTotal * 0.05,
              'items': vendorItems,
              'itemCount': itemCount,
            });
          }
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Table.fromTextArray(
              headers: ['Order #', 'Date', 'Status', 'Items', 'Total', 'Earning', 'Commission'],
                ...
                pw.Align(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 5),
                      pw.Text(
                        'Total Revenue: \$${_calculateTotalEarnings().toInt()}',
